...
cp /home/fuchs/sojus-setup/tool_tiers.json   /etc/sojus/tool_tiers.json
chmod 644 /etc/sojus/core.py /etc/sojus/memory_mcp.py /etc/sojus/tool_groups.json /etc/sojus/tool_tiers.json
echo "  ✅ core.py, memory_mcp.py, tool_groups.json, tool_tiers.json kopiert"
